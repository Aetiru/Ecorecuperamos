                        ...
                        <div class="blog_left_sidebar">
                               ...
                               <div class="col-md-3">
                                   <div class="blog_info text-right">
                                        <div class="post_tag">
                                            ...
                                            <a class="active" href="#">Zona de aprovechamiento.</a>
                                            <a href="#"></a>
                                            <a href="#"></a>
                                        </div>
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        <img src="img/blog/p-ecologico/p-eco.jpg" alt="">
                                        <div class="blog_details">
                                            <a href="single-blog.php"><h2>Zona de aprovechamiento</h2></a>
                                            <p>Centro de acopio de una de nuestras organizaciones el cual se le hace el mantenimiento, limpieza, lavado y barrida para mantenerlo en optimas condiciones para desarrollar los diferentes procesos de separación.</p>
                                            <a href="single-blog.php" class="blog_btn">Ver Mas</a>
                                        </div>
                                    </div>
                                </div>
                            </article>
                            <article class="row blog_item">
                               ...
                               <div class="blog_info text-right">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        <img src="img/blog/p-ecologico/p-eco1.jpg" alt="">
                                        <div class="blog_details">
                                            <a href="single-blog.php"><h2>Zona de aprovechamiento</h2></a>
                                            <p>Centro de acopio de una de nuestras organizaciones el cual se le hace el mantenimiento, limpieza, lavado y barrida para mantenerlo en optimas condiciones para desarrollar los diferentes procesos de separación.</p>
                                            <a href="single-blog.php" class="blog_btn">Ver Mas</a>
                            ...
                            <article class="row blog_item">
                               ...
                               <div class="blog_info text-right">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        <img src="img/blog/p-ecologico/p-eco2.jpg" alt="">
                                        <div class="blog_details">
                                            <a href="single-blog.php"><h2>Zona de aprovechamiento</h2></a>
                                            <p>Centro de acopio de una de nuestras organizaciones el cual se le hace el mantenimiento, limpieza, lavado y barrida para mantenerlo en optimas condiciones para desarrollar los diferentes procesos de separación.</p>
                                            <a href="single-blog.php" class="blog_btn">Ver Mas</a>
                            ...
                            <article class="row blog_item">
                               ...
                               <div class="blog_info text-right">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        <img src="img/blog/p-ecologico/p-eco3.jpg" alt="">
                                        <div class="blog_details">
                                            <a href="single-blog.php"><h2>Zona de aprovechamiento</h2></a>
                                            <p>Centro de acopio de una de nuestras organizaciones el cual se le hace el mantenimiento, limpieza, lavado y barrida para mantenerlo en optimas condiciones para desarrollar los diferentes procesos de separación.</p>                             
                                            <a href="single-blog.php" class="blog_btn">Ver Mas</a>
                            ...
                            <article class="row blog_item">
                               ...
                               <div class="blog_info text-right">
                                        ...
                                        <ul class="blog_meta list">
                                            ...
                                            <li><a href="#">300 Visitas<i class="lnr lnr-eye"></i></a></li>
                                            <li><a href="#">06 Comentarios<i class="lnr lnr-bubble"></i></a></li>
                                        </ul>
                                    </div>
                               </div>
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        <img src="img/blog/p-ecologico/p-eco4.jpg" alt="">
                                        <div class="blog_details">
                                            <a href="#"><h2>Punto Ecologico</h2></a>
                                            <p>La zona de punto ecológico reemplaza notablemente a las demás canecas y cuenta con la ventaja de clasificar cada elemento. Esto facilita el depósito con tranquilidad de cualquiera de los residuos según su categoría. Para facilitar su uso los tres recipientes cuentan con un color diferente y una breve descripción, donde se indica con claridad donde se debe ubicar cada residuo.</p>
                                            <a href="info-punto-ecologico.php" class="blog_btn">Ver Mas</a>
                                        </div>
                                    </div>
                                </div>
                            </article>
                            <article class="row blog_item">
                               ...
                               <div class="blog_info text-right">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        <img src="img/blog/p-ecologico/p-eco5.jpg" alt="">
                                        <div class="blog_details">
                                            <a href="#"><h2>Punto Ecologico</h2></a>
                                            <p>La zona de punto ecológico reemplaza notablemente a las demás canecas y cuenta con la ventaja de clasificar cada elemento. Esto facilita el depósito con tranquilidad de cualquiera de los residuos según su categoría. Para facilitar su uso los tres recipientes cuentan con un color diferente y una breve descripción, donde se indica con claridad donde se debe ubicar cada residuo.</p>
                                            <a href="info-punto-ecologico.php" class="blog_btn">Ver Mas</a>
                            ...
                            <nav class="blog-pagination justify-content-center d-flex">
                                <ul class="pagination">
                                    ...
                                    <li class="page-item "><a href="social.php" class="page-link">1</a></li>
                                    <li class="page-item "><a href="social2.php" class="page-link">2</a></li>
                                    <li class="page-item active"><a href="social3.php" class="page-link">3</a></li>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
                    <div class="footer-social">
                        ...
                        <a href="https://www.instagram.com/ecor_s.a.s/" target="_blank"><i class="fa fa-instagram"></i></a>
                    </div>
                </div>
            </div>
        </footer>
