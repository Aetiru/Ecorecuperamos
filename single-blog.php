                    ...
                    <div class="col-lg-8 posts-list">
                        <div class="single-post row">
                            ...
                            <div class="col-lg-9 col-md-9 blog_details">
                                <h2>Zona de aprovechamiento</h2>
                                <p class="excert">
                                Centro de acopio de una de nuestras organizaciones el cual se le hace el mantenimiento, limpieza, lavado y barrida para mantenerlo en optimas condiciones para desarrollar los diferentes procesos de separación. 
                                </p>
                                <p>
                        ...
                        <div class="navigation-area">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                                    <div class="detials">
                                        <p>Siguiente Post</p>
                                        <a href="info-charla.php"><h4>Socializacion del proyecto de gestion.</h4></a>
                                    </div>
                                    <div class="arrow">
                            ...
                            <aside class="single_sidebar_widget popular_post_widget">
                                ...
                                <div class="media post_item">
                                    ...
                                    <div class="media-body">
                                        <a href="#"><h3>Socializacion de proyecto </h3></a>
                                        <p>Charla general</p>
                                    </div>
                                </div>
                                <div class="media post_item">
