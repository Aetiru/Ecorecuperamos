...
.btn-info {
    ...
    <script type="text/JavaScript">
        function validaDatos(formulario){
            if ((form.name.value.length == 0) || (form.identificacion.value.length == 0) || (form.email.value.length == 0) || (form.departamento.value.length == 0) || (form.ciudad.value.length == 0)|| (form.direccion.value.length == 0) || (form.asunto.value.length == 0) || (form.mensaje.value.length == 0) || (form.remitente.value.length == 0)){
...
<body style="background-image: url(./rice-plantation-1822444_1920.jpg);  background-repeat: no-repeat; background-position: 100% 100%;">
...
<form class="text-center border border-light p-5" action="" onsubmit=" return validaDatos(this);" id="form" value="1" method="POST"  style="background: #FFFFFF;>
    ...
    <div class="form-row mb-4">
        <div class="col">
            <!-- First name -->
            <input type="text" id="defaultRegisterFormFirstName"  class="form-control" placeholder="Departamento" onkeypress="return soloLetras(event);" name="departamento">
        </div>
        <div class="col">
            <!-- Last name -->
            <input type="text" id="defaultRegisterFormLastName"  class="form-control" placeholder="Ciudad" onkeypress="return soloLetras(event);" name="ciudad">
        </div>
        <div class="col">
            <!-- Last name -->
